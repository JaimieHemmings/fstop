...
urlpatterns = [
    ...
    path("articles/",
         views.cp_articles, name="cp_articles"),
    ...
    path("manage-payments/new-payment/",
         views.new_payment, name="new_payment"),
    path(
    ...
    # CMS Paths
    path("cms-homepage/",
         views.cp_cms_home, name="cp_cms_home"),

    path("cms-edit-hero/", views.cp_cms_hero, name="cp_cms_hero"),
    path("cms-edit-about-home/",
         views.cp_cms_about_home_edit, name="cp_cms_about_home_edit"),
    path("cms-edit-trusted-by/",
         views.cp_cms_trusted_by_edit, name="cp_cms_trusted_by_edit"),
    ...
    path("cms-faq-section/delete-faq-confirm/<int:faq_id>/",
         views.cms_delete_faq_confirm, name="cms_delete_faq_confirm"),
